#include "ComputerEngineeringStudent.h"

// Constructor
ComputerEngineeringStudent::ComputerEngineeringStudent(string newName, string newPassword,
...
void ComputerEngineeringStudent::aboutAuthor() {
...
// Getters
string ComputerEngineeringStudent::getCourse() {
    return course;
}

// Getters
string ComputerEngineeringStudent::getUni() {
    return Uni;
}

// Getters
string ComputerEngineeringStudent::getPosition() {
    return position;
}   